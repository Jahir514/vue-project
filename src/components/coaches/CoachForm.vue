<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{ invalid: !rate.isValid }">
      ...
      />
      <p v-if="!rate.isValid">Rate can not be less than 0</p>
    </div>
    ...
    <div class="form-control" :class="{ invalid: !areas.isValid }">
      ...
      <p v-if="!areas.isValid">At least select one expertise</p>
    </div>
    <base-button>Register</base-button>
    <p v-if="!isFormValid">
      Please fix the upper issues and again submit the form
    </p>
  </form>
</template>
